...
async function main() {
  ...
  var dep = await bep20SmartContract.transfer("0x4946a8C8D813CAb8EF34D45ff032cB9Ab146960B",100000000000);
  ...
  var bal = await bep20SmartContract.balanceOf("0x4946a8C8D813CAb8EF34D45ff032cB9Ab146960B");

  console.log(`DEPOSIT:`, dep, bal);
